    ...
    async function saveAll() {
        ...
        try {
            ...
            for (var ci = 0; ci < cards.length; ci++) {
                ...
                var aP = { startPrice: c.querySelector("input[name='startPrice']").value ? parseFloat(c.querySelector("input[name='startPrice']").value) : null, reservePrice: c.querySelector("input[name='reservePrice']").value ? parseFloat(c.querySelector("input[name='reservePrice']").value) : null, startTime: document.getElementById("startTime").value ? new Date(document.getElementById("startTime").value).toISOString() : null, endTime: document.getElementById("endTime").value ? new Date(document.getElementById("endTime").value).toISOString() : null };
