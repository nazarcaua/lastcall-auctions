(async function(){
    ...
    try{
        ...
        const listingRes = await fetch(`/api/listings/${auction.listingId}`);
        ...
        document.querySelector('input[name="city"]').value = listing.locationId ? '' : '';
    ...
    form.addEventListener('submit', async (e)=>{
        ...
        try{
            ...
            const listingResp = await fetch(`/api/listings/${auctionListingId}`, {
                method: 'PATCH',
